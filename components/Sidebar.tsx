...
import { Home, Building2, Users, LogOut, Crown, Sparkles } from "lucide-react";
import {
    SignedIn,
    SignedOut,
    SignInButton,
            ...
            <div className="flex-1 flex flex-col p-6">
                ...
                <Link href="/" className="flex items-center gap-3 mb-10 group">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-500 group-hover:text-gray-400 transition-colors">Dashboard</p>
                    </div>
                </Link>
                ...
                <div className="mt-auto pt-6">
                    <div className="group relative p-4 bg-linear-to-br from-white/5 to-white/2 border border-white/10 rounded-xl hover:border-white/20 hover:from-white/7 hover:to-white/3 transition-all duration-300 overflow-hidden">
                        <div className="absolute inset-0 bg-linear-to-br from-yellow-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    ...
                    <div className="group flex items-center gap-3 p-2.5 rounded-xl hover:bg-white/5 transition-all duration-200">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <div className="text-xs text-gray-500 truncate group-hover:text-gray-400 transition-colors">
                                {String(user?.publicMetadata?.role ?? "Member")}
                            </div>
                        </div>
                        <SignOutButton>
